// Définition des types pour les props du composant JiraIcon
type JiraIconProps = {
  size: number;
  className?: string;
};
 ...
 * Composant JiraIcon.
 *
 * Rendu d'une icône SVG représentant jira.
 * Le composant permet de personnaliser la taille et d'ajouter des classes CSS pour le style.
 *
 * @param {JiraIconProps} props - Les propriétés du composant.
 * @returns {JSX.Element} Un élément SVG représentant l'icône jira.
 */
const JiraIcon = ({ size, className }: JiraIconProps): JSX.Element => {
  return (
    <svg
      width={size}
      height={size}
