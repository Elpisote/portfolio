// Définition des types pour les props du composant CSharpIcon
...
/**
 * Composant CSharpIcon.
 *
 * Rendu d'une icône SVG représentant le langage C#.
 * Le composant permet de personnaliser la taille et d'ajouter des classes CSS pour le style.
 *
 * @param {CSharpIconProps} props - Les propriétés du composant.
 * @returns {JSX.Element} Un élément SVG représentant l'icône C#.
 */
const CSharpIcon = ({ size, className }: CSharpIconProps): JSX.Element => {
  return (
    <svg
      width={size}
      height={size}
